...
@onready var left_actor: Node2D = $"background/actor_left"
@onready var left_actor_portrait: TileView = $"background/actor_left/actor_view"
@onready var left_actor_name: Label = $"background/actor_left/name"

@onready var right_actor: Node2D = $"background/actor_right"
@onready var right_actor_portrait: TileView = $"background/actor_right/actor_view"
