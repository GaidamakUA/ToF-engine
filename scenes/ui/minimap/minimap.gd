...
var snow_tiles: Array[String] = ["ground_snow"]
var sand_tiles: Array[String] = ["ground_sand", "frame_wheat"]
var concrete_tiles: Array[String] = ["ground_concrete"]
var river_tiles: Array[String] = [
    "ground_river1",
    "ground_river2",
    "ground_snow_river1",
    "ground_snow_river2",
...
var dirt_road_tiles: Array[String] = [
    "ground_dirt_road1",
    "ground_dirt_road2",
    "ground_dirt_road3",
    "ground_dirt_road4",
...
var mountain_tiles: Array[String] = [
    "nature_big_rocks1",
    "nature_big_rocks2",
    "nature_big_rocks3",
    "nature_big_rocks4",
]
var forest_tiles: Array[String] = [
    "nature_trees1",
    "nature_trees2",
    "nature_trees3",
    "nature_trees4",
...
var forest_autumn_tiles: Array[String] = [
    "nature_trees7",
    "nature_trees8",
    "nature_trees9",
    "nature_trees14",
...
func remove_from_cache(map_name: String) -> void:
    if self.cache.has(map_name):
