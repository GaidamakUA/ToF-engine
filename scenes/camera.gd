...
const CAMERA_AXIS_X: JoyAxis = JOY_AXIS_RIGHT_X
const CAMERA_AXIS_Y: JoyAxis = JOY_AXIS_RIGHT_Y
const CAMERA_AXIS_ZOOM_IN: JoyAxis = JOY_AXIS_TRIGGER_RIGHT
const CAMERA_AXIS_ZOOM_OUT: JoyAxis = JOY_AXIS_TRIGGER_LEFT
